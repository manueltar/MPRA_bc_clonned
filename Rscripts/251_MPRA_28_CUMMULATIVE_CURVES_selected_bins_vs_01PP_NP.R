...
cumulative_CT_Label2_and_Log_Rank_test_enhancer = function(option_list)
{
  ...
  ### CUMULATIVE_CLASSES_PREPARED_Druggable_target #----
  
  CUMULATIVE_CLASSES_PREPARED_Druggable_target<-readRDS(file=opt$CUMULATIVE_CLASSES_PREPARED_Druggable_target)
  
  CUMULATIVE_CLASSES_PREPARED_Druggable_target$Disease<-'Druggable_target'
  
  cat("CUMULATIVE_CLASSES_PREPARED_Druggable_target_0\n")
  cat(str(CUMULATIVE_CLASSES_PREPARED_Druggable_target))
  cat("\n")
  cat(str(unique(CUMULATIVE_CLASSES_PREPARED_Druggable_target$VAR)))
  cat("\n")
  
  ### CUMULATIVE_CLASSES_PREPARED_top_500 #----
  
  CUMULATIVE_CLASSES_PREPARED_top_500<-readRDS(file=opt$CUMULATIVE_CLASSES_PREPARED_top_500)
  
  CUMULATIVE_CLASSES_PREPARED_top_500$Disease<-'top_500'
  
  cat("CUMULATIVE_CLASSES_PREPARED_top_500_0\n")
  cat(str(CUMULATIVE_CLASSES_PREPARED_top_500))
  cat("\n")
  cat(str(unique(CUMULATIVE_CLASSES_PREPARED_top_500$VAR)))
  cat("\n")
  
  ### CUMULATIVE_CLASSES_PREPARED_top_restricted_500 #----
  
  CUMULATIVE_CLASSES_PREPARED_top_restricted_500<-readRDS(file=opt$CUMULATIVE_CLASSES_PREPARED_top_restricted_500)
  
  CUMULATIVE_CLASSES_PREPARED_top_restricted_500$Disease<-'top_restricted_500'
  
  
  cat("CUMULATIVE_CLASSES_PREPARED_top_restricted_500_0\n")
  cat(str(CUMULATIVE_CLASSES_PREPARED_top_restricted_500))
  cat("\n")
  cat(str(unique(CUMULATIVE_CLASSES_PREPARED_top_restricted_500$VAR)))
  cat("\n")
  
  
  #### REP ----
  
  REP<-rbind(CUMULATIVE_CLASSES_PREPARED_Druggable_target,CUMULATIVE_CLASSES_PREPARED_top_500,CUMULATIVE_CLASSES_PREPARED_top_restricted_500)
  ...
  path5<-paste(out2,'CT_CLASS_PRIORITISED_BINS','/', sep='')
...
main = function() {
  ...
  option_list <- list(
    ...
    make_option(c("--out2"), type="character", default=NULL, 
                metavar="type", 
                help="Path to tab-separated input file listing regions to analyze. Required."),
    make_option(c("--CUMULATIVE_CLASSES_PREPARED_Druggable_target"), type="character", default=NULL, 
                metavar="type", 
                help="Path to tab-separated input file listing regions to analyze. Required."),
    make_option(c("--CUMULATIVE_CLASSES_PREPARED_top_500"), type="character", default=NULL, 
                metavar="type", 
                help="Path to tab-separated input file listing regions to analyze. Required."),
    make_option(c("--CUMULATIVE_CLASSES_PREPARED_top_restricted_500"), type="character", default=NULL, 
                metavar="type", 
                help="Path to tab-separated input file listing regions to analyze. Required."),
