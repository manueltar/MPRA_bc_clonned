...
CLASSIFICATION_AT = function(option_list)
{
  ...
  cat("\n")
  cat(str(unique(ACTIVE_TILES$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  ...
  cat(str(unique(ACTIVE_TILES$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  cat(str(unique(ACTIVE_TILES$KEY)))
  cat("\n")
  ...
  cat(str(unique(ACTIVE_TILES$KEY)))
  cat("\n")
  cat(str(unique(ACTIVE_TILES$carried_variants)))
  cat("\n")
  ...
  cat(str(unique(ACTIVE_TILES$carried_variants)))
  cat("\n")
  cat(str(unique(ACTIVE_TILES$KEY_Plus_carried_variants)))
  cat("\n")
  ...
  cat("\n")
  cat(str(unique(ACTIVE_TILES_Fq$KEY_Plus_carried_variants)))
  cat("\n")
  ...
  cat("\n")
  cat(str(unique(ACTIVE_TILES_Fq_enhancer_Fq$KEY_Plus_carried_variants)))
  cat("\n")
  ...
  cat("\n")
  cat(str(unique(ACTIVE_TILES_Fq_ASE$KEY_Plus_carried_variants)))
  cat("\n")
  ...
  cat("\n")
  cat(str(unique(ACTIVE_TILES_Fq_ASE_Fq$KEY_Plus_carried_variants)))
  cat("\n")
  ...
  cat("\n")
  cat(str(unique(ACTIVE_TILES_Fq_E_Plus_ASE$KEY_Plus_carried_variants)))
  cat("\n")
  ...
  cat("\n")
  cat(str(unique(ACTIVE_TILES_Fq_E_Plus_ASE_Fq$KEY_Plus_carried_variants)))
  cat("\n")
