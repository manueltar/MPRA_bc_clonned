...
ggridge.graphs = function(option_list)
{
  ...
  Rosetta_df$REAL_TILE_Plus_carried_variants<-gsub("chr","",Rosetta_df$REAL_TILE_Plus_carried_variants)
  Rosetta_df$carried_variants<-gsub("chr","",Rosetta_df$carried_variants)
  ...
  cat("\n")  
  cat(str(unique(Rosetta_df$carried_variants)))
  cat("\n")  
  
  cat("MPRA_Real_tile_REMEMBER\n")
  cat(str(MPRA_Real_tile))
  cat("\n")
  ...
  check_1<-Rosetta_df$REAL_TILE_Plus_carried_variants[which(Rosetta_df$REAL_TILE_Plus_carried_variants%in%MPRA_Real_tile_subset$REAL_TILE_Plus_carried_variants)]
  ...
  for(i in 1:length(features))
  {
    ...
    list_values_sel$REAL_TILE_Plus_carried_variants<-gsub("chr","",list_values_sel$REAL_TILE_Plus_carried_variants)
