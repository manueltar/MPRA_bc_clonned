...
QC_PASS_CT = function(option_list)
{
  ...
  Annot_gDNA_df_QC_PASS$accepted_colnames<-paste("aggregated_counts",Annot_gDNA_df_QC_PASS$batch,Annot_gDNA_df_QC_PASS$bc,sep="_")
  ...
  Annot_cDNA_df_QC_PASS$accepted_colnames<-paste("aggregated_counts",Annot_cDNA_df_QC_PASS$batch,Annot_cDNA_df_QC_PASS$bc,sep="_")
