...
data_wrangling_1 = function(option_list)
{
  ...
  cat(str(RESULTS))
  cat("\n")
  cat(str(unique(RESULTS$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  
  
  RESULTS$REAL_TILE_Plus_carried_variants<-gsub("chr","",RESULTS$REAL_TILE_Plus_carried_variants)
...
data_wrangling_2 = function(option_list)
{
  #### READ and transform type ----
  ...
  Rosetta_df$Label[which(Rosetta_df$Label == "Negative_Control_Genomic_Regions")]<-"NCGR"
  Rosetta_df$Label[which(Rosetta_df$Label == "UNDETERMINED_CTRL")]<-"Enhancer_CTRL"
  Rosetta_df$Label[is.na(Rosetta_df$Label)]<-"Explore"
  ...
  cat("\n")
  cat(str(unique(Rosetta_df$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  cat(sprintf(as.character(names(summary(as.factor(Rosetta_df$Label))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(Rosetta_df$Label)))))
  cat("\n")
  ...
  cat(str(unique(Rosetta_df$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  cat(sprintf(as.character(names(summary(Rosetta_df$Tile)))))
  cat("\n")
  cat(sprintf(as.character(summary(Rosetta_df$Tile))))
  cat("\n")
  
  
  
  Rosetta_df$Label_2<-Rosetta_df$Label
  
 
  Rosetta_df$Label<-factor(Rosetta_df$Label,
                             levels=c("ASE_CTRL","ASSAYED_VARIANT","Enhancer_CTRL","NCGR","Explore"),
                             ordered=T)
  ...
  # ASE_CTRL ASSAYED_VARIANT Enhancer_CTRL NCGR Explore
  # 41 9256 59 10 207
  
  
  
  REAL_TILE_DF_NEG_CTRLS<-Rosetta_df[which(Rosetta_df$Label == 'NCGR'),]
  ...
  cat(sprintf(as.character(names_medians_object)))
  cat("\n")
  ...
  for(i in 1:length(names_medians_object))
  {
    ...
    cat("--------------------------------------------------------------->\t")
    cat(sprintf(as.character(names_medians_object_sel)))
    cat("\n")
  ...
  cat(str(temp))
  cat("\n")
  cat(str(unique(temp$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  ...
  cat("\n")
  cat(str(unique(MPRA_Real_Tile$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  cat(sprintf(as.character(names(summary(MPRA_Real_Tile$Tile)))))
  cat("\n")
  cat(sprintf(as.character(summary(MPRA_Real_Tile$Tile))))
  cat("\n")
  cat(sprintf(as.character(names(summary(MPRA_Real_Tile$Label_2)))))
  cat("\n")
  cat(sprintf(as.character(summary(MPRA_Real_Tile$Label_2))))
  cat("\n")
  ...
  MPRA_Real_Tile_subset$carried_variants<-gsub("chr","",MPRA_Real_Tile_subset$carried_variants)
  MPRA_Real_Tile_subset$REAL_TILE_Plus_carried_variants<-gsub("chr","",MPRA_Real_Tile_subset$REAL_TILE_Plus_carried_variants)
  
  
  cat("MPRA_Real_Tile_subset\n")
  cat(str(MPRA_Real_Tile_subset))
  cat("\n")
  cat(str(unique(MPRA_Real_Tile_subset$carried_variants)))
  cat("\n")
...
QC2_barplots_plots = function(option_list)
{
  ...
  for(i in 1:length(Cell_Types_vector))
  {
    ...
    cat("\n")
    cat(str(unique(REP$REAL_TILE_Plus_carried_variants)))
    cat("\n")
    ...
    Gather<-rbind(Gather,Freq.table_TOTAL)
    ...
    Gather2<-rbind(Gather2,Freq.table_pool)
    ...
    Gather3<-rbind(Gather3,Freq.table_Label)
  ...
  setwd(out2)
  write.table(Gather, file="DEF_table_QC.txt",sep="\t",quote=F, row.names = F)

  write.table(Gather2, file="DEF_table_pools.txt",sep="\t",quote=F, row.names = F)

  write.table(Gather3, file="DEF_table_Label.txt",sep="\t",quote=F, row.names = F)
...
data_wrangling_after_QC2_plots = function(option_list)
{
  ...
  cat("MPRA_Real_Tile_QC2_PASS_0\n")
  cat(str(MPRA_Real_Tile_QC2_PASS))
  cat("\n")
  cat(str(unique(MPRA_Real_Tile_QC2_PASS$VAR)))
  cat("\n")
  cat(str(unique(MPRA_Real_Tile_QC2_PASS$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  cat("variable\n")
  cat(sprintf(as.character(names(summary(as.factor(MPRA_Real_Tile_QC2_PASS$variable))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(MPRA_Real_Tile_QC2_PASS$variable)))))
  cat("\n")
  cat(sprintf(as.character(names(summary(MPRA_Real_Tile_QC2_PASS$Label_2)))))
  cat("\n")
  cat(sprintf(as.character(summary(MPRA_Real_Tile_QC2_PASS$Label_2))))
  cat("\n")
  cat(sprintf(as.character(names(summary(as.factor(MPRA_Real_Tile_QC2_PASS$variable))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(MPRA_Real_Tile_QC2_PASS$variable)))))
  ...
  cat("\n")
  cat(str(unique(MPRA_Real_Tile_QC2_PASS_wide$VAR)))
  cat("\n")
  cat(str(unique(MPRA_Real_Tile_QC2_PASS_wide$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  ...
  cat("\n")
  cat(sprintf(as.character(names(summary(interaction(MPRA_Real_Tile_QC2_PASS_wide_subset$Cell_Type,MPRA_Real_Tile_QC2_PASS_wide_subset$QC2_CLASS))))))
  cat("\n")
  cat(sprintf(as.character(summary(interaction(MPRA_Real_Tile_QC2_PASS_wide_subset$Cell_Type,MPRA_Real_Tile_QC2_PASS_wide_subset$QC2_CLASS)))))
  cat("\n")
  ...
  cat("MPRA_Real_Tile_AFTER_QC_PASS\n")
  cat(str(MPRA_Real_Tile))
  cat("\n")
  cat(str(unique(MPRA_Real_Tile$VAR)))
  cat("\n")
  ...
  cat("\n")
  cat(str(unique(RESULTS_SIG_enhancer$VAR)))
  cat("\n")
  cat(str(unique(RESULTS_SIG_enhancer$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  cat(sprintf(as.character(names(summary(RESULTS_SIG_enhancer$Label_2)))))
  cat("\n")
  cat(sprintf(as.character(summary(RESULTS_SIG_enhancer$Label_2))))
  cat("\n")
  ...
  check_1<-RESULTS_SIG_enhancer[which(RESULTS_SIG_enhancer$Label_2 == "ASE_CTRL"),]
  
  
  cat("check_1\n")
  cat(str(check_1))
  cat("\n")
  cat(str(unique(check_1$VAR)))
  cat("\n")
  cat(str(unique(check_1$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  cat(sprintf(as.character(names(summary(check_1$value)))))
  cat("\n")
  cat(sprintf(as.character(summary(check_1$value))))
  cat("\n")
  cat(sprintf(as.character(names(summary(check_1$enhancer_logpval)))))
  cat("\n")
  cat(sprintf(as.character(summary(check_1$enhancer_logpval))))
  cat("\n")
  
  setwd(out2)
  write.table(check_1, file="ASE_ctrls_enhancer.tsv", sep="\t", quote=F, row.names = F)
  ...
  cat("RESULTS_SIG_enhancer_filter_1_enhancer_logval_Threshold\n")
  cat(str(RESULTS_SIG_enhancer))
  cat("\n")
  
  ################################## check the positive controls
  
  check_2<-RESULTS_SIG_enhancer[which(RESULTS_SIG_enhancer$Label_2 == "ASE_CTRL"),]
  ...
  # 
  # 
  cat("RESULTS_SIG_enhancer_NO_FC_filter\n")
  cat(str(RESULTS_SIG_enhancer))
  cat("\n")
  ...
  indx.int<-c(which(colnames(RESULTS_SIG_enhancer) == "REAL_TILE_Plus_carried_variants"),which(colnames(RESULTS_SIG_enhancer) == "Cell_Type"),which(colnames(RESULTS_SIG_enhancer) == "CLASS_enhancer"))
  
  RESULTS_SIG_enhancer_subset<-unique(RESULTS_SIG_enhancer[,indx.int])

  # distribution_SIG_enhancer_Cell_Type
  # K562 CHRF HL60 THP1
  # 1471 3679 2089 766
  ...
  cat("\n")
  cat(str(unique(RESULTS_SIG_ASE$VAR)))
  cat("\n")
  cat(str(unique(RESULTS_SIG_ASE$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  cat(sprintf(as.character(names(summary(RESULTS_SIG_ASE$Label_2)))))
  cat("\n")
  cat(sprintf(as.character(summary(RESULTS_SIG_ASE$Label_2))))
  cat("\n")
  cat(sprintf(as.character(names(summary(RESULTS_SIG_ASE$value)))))
  cat("\n")
  cat(sprintf(as.character(summary(RESULTS_SIG_ASE$value))))
  cat("\n")
  cat(sprintf(as.character(names(summary(RESULTS_SIG_ASE$enhancer_logpval)))))
  cat("\n")
  cat(sprintf(as.character(summary(RESULTS_SIG_ASE$enhancer_logpval))))
  cat("\n")
  
  
  check_1<-RESULTS_SIG_ASE[which(RESULTS_SIG_ASE$Label_2 == "ASE_CTRL"),]
  ...
  setwd(out2)
  write.table(check_1, file="ASE_ctrls_ASE.tsv", sep="\t", quote=F, row.names = F)
  ...
  check_2<-RESULTS_SIG_ASE[which(RESULTS_SIG_ASE$Label_2 == "ASE_CTRL"),]
  ...
  cat(sprintf(as.character(summary(check_1$value))))
  cat("\n")
  cat(sprintf(as.character(names(summary(check_1$ASE_logpval)))))
  cat("\n")
  cat(sprintf(as.character(summary(check_1$ASE_logpval))))
  cat("\n")
  
  indx.int<-c(which(colnames(RESULTS_SIG_ASE) == "REAL_TILE_Plus_carried_variants"),which(colnames(RESULTS_SIG_ASE) == "Cell_Type"),which(colnames(RESULTS_SIG_ASE) == "CLASS_ASE"))
  ...
  #### E_Plus_ASE INTERSECTION SIG ----
  
  cat("RESULTS_SIG_enhancer_subset_REMEMBER\n")
  cat(str(RESULTS_SIG_enhancer_subset))
  cat("\n")
   cat(str(unique(RESULTS_SIG_enhancer_subset$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  
  cat("RESULTS_SIG_ASE_subset_REMEMBER\n")
  cat(str(RESULTS_SIG_ASE_subset))
  cat("\n")
  cat(str(unique(RESULTS_SIG_ASE_subset$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  
    
  
  RESULTS_DEF<-merge(RESULTS_SIG_enhancer_subset,
                                RESULTS_SIG_ASE_subset,
                                by=c("REAL_TILE_Plus_carried_variants","Cell_Type"),
                                all=T)
        
  
  RESULTS_DEF$CLASS_E_Plus_ASE<-NA
  
  RESULTS_DEF$CLASS_E_Plus_ASE[which(RESULTS_DEF$CLASS_enhancer == "enhancer" &
                                                  RESULTS_DEF$CLASS_ASE == "ASE")]<-"E_Plus_ASE"

  
  cat("RESULTS_DEF_0\n")
  cat(str(RESULTS_DEF))
  cat("\n")
  cat(str(unique(RESULTS_DEF$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  
  check<-RESULTS_DEF[which(RESULTS_DEF$CLASS_E_Plus_ASE == "E_Plus_ASE"),]
  
  cat("check_0\n")
  cat(str(check))
  cat("\n")
  cat(str(unique(check$REAL_TILE_Plus_carried_variants)))
  cat("\n")
  ...
  RESULTS_DEF$DEF_CLASS<-"NA"
  
  RESULTS_DEF$DEF_CLASS[!is.na(RESULTS_DEF$CLASS_ASE)]<-RESULTS_DEF$CLASS_ASE[!is.na(RESULTS_DEF$CLASS_ASE)]
  
  RESULTS_DEF$DEF_CLASS[!is.na(RESULTS_DEF$CLASS_enhancer)]<-RESULTS_DEF$CLASS_enhancer[!is.na(RESULTS_DEF$CLASS_enhancer)]
  
  RESULTS_DEF$DEF_CLASS[!is.na(RESULTS_DEF$CLASS_E_Plus_ASE)]<-RESULTS_DEF$CLASS_E_Plus_ASE[!is.na(RESULTS_DEF$CLASS_E_Plus_ASE)]
  
  cat("RESULTS_DEF_1\n")
  cat(str(RESULTS_DEF))
  cat("\n")
  cat("distribution_SIG_ASE_Cell_Type\n")
  cat(sprintf(as.character(names(summary(as.factor(RESULTS_DEF$DEF_CLASS))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(RESULTS_DEF$DEF_CLASS)))))
  cat("\n")
  
  
  RESULTS_DEF$DEF_CLASS<-factor(RESULTS_DEF$DEF_CLASS,
                                levels=c("E_Plus_ASE","enhancer","ASE"),
                                ordered=T)
  
  indx.int<-c(which(colnames(RESULTS_DEF) == "REAL_TILE_Plus_carried_variants"),
              which(colnames(RESULTS_DEF) == "Cell_Type"),
              which(colnames(RESULTS_DEF) == "DEF_CLASS"))
  
  
  RESULTS_DEF_subset<-unique(RESULTS_DEF[,indx.int])
  
  cat("RESULTS_DEF_subset\n")
  cat(str(RESULTS_DEF_subset))
  cat("\n")
  ...
  write.table(RESULTS_DEF_subset,file="ACTIVE_TILES.txt", sep="\t", quote=F,row.names = F)
  
  write.table(RESULTS_DEF,file="ACTIVE_TILES_for_cummulative.txt", sep="\t", quote=F,row.names = F)
...
add_VEP_info = function(option_list)
{
  #### READ and transform type ----
  ...
  indx.int<-c(which(colnames(VEP_CSQ) == "VAR"),
              which(colnames(VEP_CSQ) == "VEP_DEF_LABELS"))
...
volcano_graphs= function(option_list)
{
  ...
  for(i in 1:length(Cell_Types_vector))
  {
    ...
    for(l in 1:length(features))
    {
      ...
      REP<-unique(MPRA_Real_Tile_sel[which(MPRA_Real_Tile_sel$variable == features_sel),-which(colnames(MPRA_Real_Tile_sel) == "VEP_DEF_LABELS")])
...
main = function() {
 ...
 data_wrangling_1(opt)
 data_wrangling_2(opt)
